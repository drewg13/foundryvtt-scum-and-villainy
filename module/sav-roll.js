...
async function showChatRollMessage(r, zeromode, attribute_name = "", position = "", effect = "") {
  ...
  let roll_status = getSaVRollStatus(rolls, zeromode);
  ...
  let result = await renderTemplate("systems/scum-and-villainy/templates/sav-roll.html", {rolls: rolls, roll_status: roll_status, attribute_label: attribute_label, position: position, position_localize: position_localize, effect: effect, effect_localize: effect_localize});
 ...
 * @param {Boolean} zeromode 
 */
export function getSaVRollStatus(rolls, zeromode = false) {
