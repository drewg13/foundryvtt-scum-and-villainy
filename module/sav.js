...
Hooks.once("init", async function() {
  ...
  Handlebars.registerHelper('sav-clock', function(parameter_name, type, current_value, uniq_id) {
    ...
    html += `<div id="sav-clock-${uniq_id}" class="sav-clock clock-${type} clock-${type}-${current_value}" style="background-image:url('/systems/scum-and-villainy/themes/default/${type}clock_${current_value}.webp');">`;
