...
Hooks.once("init", async function () {
  ...
  Actors.registerSheet("scum-and-villainy", SaVActorSheet, {
    types: ["character"],
    makeDefault: true,
  });
  Actors.registerSheet("scum-and-villainy", SaVNPCSheet, {
    types: ["npc"],
    makeDefault: true,
  });
  Actors.registerSheet("scum-and-villainy", SaVShipSheet, {
    types: ["ship"],
    makeDefault: true,
  });
  Actors.registerSheet("scum-and-villainy", SaVClockSheet, {
    types: ["\uD83D\uDD5B clock"],
    makeDefault: true,
  });
  Actors.registerSheet("scum-and-villainy", SaVUniverseSheet, {
    types: ["universe"],
    makeDefault: true,
  });
  Actors.registerSheet("scum-and-villainy", SaVFactionStatusSheet, {
    types: ["faction-status"],
    makeDefault: true,
  });
  ...
  Handlebars.registerHelper(
    "sav-clock",
    function (parameter_name, type, current_value, uniq_id, theme) {
      theme =
        typeof theme !== "object"
          ? theme
